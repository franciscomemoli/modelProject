...
class LawControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/law/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'law[name]' => 'Lorem ipsum dolor sit amet',
            'law[description]' => 'Lorem ipsum dolor sit amet',
            'law[applicationAuthority]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/law/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'law[name]' => 'Changed',
            'law[description]' => 'Changed',
            'law[applicationAuthority]' => 'Changed',
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            'law_filter[name]' => 'First%',
            'law_filter[description]' => 'First%',
            'law_filter[applicationAuthority]' => 'First%',
